...
const SECTION_GROUP = {
  ...
  panels: "clinical", clinical_trials: "treatment", gencc: "evidence", prevalence: "clinical", research_topics: "evidence",
...
const EXPLORE_LABELS = {
  ...
  research_topics: "What the research is about",
};
...
const ALL_SECTION_KEYS = ["variants", "domainmap", "pathways", "expression", "interactions",
  ...
  "clinical_trials", "panels", "gencc", "prevalence", "research_topics"];
